...
```{r, qq_pz.png, fig.align = 'center', out.width = "50%", echo=FALSE}
knitr::include_graphics("images/prostate/qq_pz_plot.png")
```
Left is the QQ plot. The x-axis of the QQ-plot represents the expected p-values under the null hypothesis, while the y-axis represents the observed p-values from the GWAS summary statistics data. Right is the PZ plot, he observed p-values on the y-axis and the corresponding p-values derived from z-scores that estimated by beta and se on the x-axis.
