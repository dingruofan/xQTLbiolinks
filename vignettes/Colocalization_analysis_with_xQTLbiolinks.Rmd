...
```{r, results = 'hide', echo=TRUE, message=FALSE, out.width = "70%", warning=FALSE, eval=FALSE}
...
- The genomic inflation factor (lambda) is labeled in the top left of the QQ-plot, and a lambda value of 1.147 indicating no strong population stratification. 
...
```{r, message=FALSE, warning=FALSE, include=FALSE}
t1 <- tempfile()
utils::download.file("http://raw.githubusercontent.com/dingruofan/exampleData/master/gwasEqtldata.txt", t1)
