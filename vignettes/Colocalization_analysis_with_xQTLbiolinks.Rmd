...
```
```{r, anno.png, fig.align = 'center', out.width = "35%", echo=FALSE}
...
```{r, results = 'hide', echo=TRUE, message=FALSE, warning=FALSE, eval=FALSE}
colocResultAll <- fread("https://master.dl.sourceforge.net/project/exampledata/colocResultAll.txt")
```
...
```{r, message=FALSE, warning=FALSE, include=FALSE}
t1 <- tempfile()
utils::download.file("https://master.dl.sourceforge.net/project/exampledata/gwasEqtldata.txt", t1)
