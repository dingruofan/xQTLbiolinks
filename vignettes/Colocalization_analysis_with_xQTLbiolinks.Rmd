...
<!-- [![I'm Caption](images/prostate_geneExpInOneTissue.png "I'm title")](I'm link){width=50%} -->
...
```{r, message=FALSE, warning=FALSE, include=FALSE}
t1 <- tempfile()
utils::download.file("http://gitee.com/stronghoney/exampleData/raw/master/gwasEqtldata.txt", t1)
...
```{r, prostate_locuscompare.png, fig.align = 'center', out.width = "60%", echo=FALSE}
...
```{r, prostate_locuszoom_gwas.png, fig.align = 'center', out.width = "60%", echo=FALSE}
...
```{r, prostate_locuszoom_eqtl.png, fig.align = 'center', out.width = "60%", echo=FALSE}
