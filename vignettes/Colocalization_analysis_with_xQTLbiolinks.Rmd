...
library(png)
library(grid)
img <- readPNG("../img/prostate/prostate_geneExpInOneTissue.png")
grid.raster(img)
```
...
library(png)
library(grid)
img <- readPNG("../img/prostate/prostate_exp_multissues.png")
grid.raster(img)
```
...
library(png)
library(grid)
img <- readPNG("../img/prostate/prostate_eqtlTissues.png")
grid.raster(img)
```
...
library(png)
library(grid)
img <- readPNG("../img/prostate/prostate_locuscompare.png")
grid.raster(img)
```
...
library(png)
library(grid)
img <- readPNG("../img/prostate/prostate_locuszoom_gwas.png")
grid.raster(img)
```
...
library(png)
library(grid)
img <- readPNG("../img/prostate/prostate_locuszoom_eqtl.png")
grid.raster(img)
```
...
library(png)
library(grid)
img <- readPNG("../img/prostate/prostate_combined.png")
grid.raster(img)
```
...
library(png)
library(grid)
img <- readPNG("../img/prostate/prostate_eQTL_exp.png")
grid.raster(img)
```
...
library(png)
library(grid)
img <- readPNG("../img/prostate/prostate_cor.png")
grid.raster(img)
```
...
library(png)
library(grid)
img <- readPNG("../img/prostate/prostate_Go.png")
grid.raster(img)
```
