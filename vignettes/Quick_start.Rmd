...
xQTLbiolinks has provided a disease target gene discovery framework to detect susceptible genes and causal variants.
```{r, colocalization_framework.png, fig.align = 'center', out.width = "80%", echo=FALSE}
knitr::include_graphics("images/quick_start/colocalization_framework.png")
```

## Before we start

To perform colocalization analysis using xQTLbiolinks, users need to provide their own GWAS summary statistics data and specify the tissue of interest.
...
```{r, eqtl_multiple_tissues, fig.align = 'center', out.width = "50%", echo=FALSE}
...
multi_tissue_coloc <- xQTLvisual_coloc( gene="ENSG00000109684.14", variantName="rs13120565", 
                                        ...
                                        "CD4+ T cell", "Kidney - Cortex", "Uterus", 
                                        "Esophagus - Mucosa", "LCL"))
```
