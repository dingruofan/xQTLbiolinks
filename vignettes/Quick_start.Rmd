...
```{r, fig.width=6, fig.height=5.2, echo=FALSE, fig.align="center"}
library(png)
library(grid)
img <- readPNG("../img/quick_start/compare.png")
grid.raster(img)
```
...
library(png)
library(grid)
img <- readPNG("../img/quick_start/gwas_legendF.png")
grid.raster(img)
```
...
library(png)
library(grid)
img <- readPNG("../img/quick_start/eqtl_legendF.png")
grid.raster(img)
```
...
library(png)
library(grid)
img <- readPNG("../img/quick_start/exp.png")
grid.raster(img)
```
...
library(png)
library(grid)
img <- readPNG("../img/quick_start/xQTLvisual_locusCombine.png")
grid.raster(img)
```
