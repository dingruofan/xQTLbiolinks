...
colocResult <- coloc.abf(
  dataset1=list(
    pvalues=gwas_eqtl$pValue.gwas, beta=gwas_eqtl$beta.gwas, type="cc", varbeta=gwas_eqtl$varbeta, s=0.4,MAF=gwas_eqtl$maf.gwas),
 dataset2=list(
...
```{r}
eqtlAsso2 <-  GTExvisual_eqtlTrait(traitGene,highlightSnp = gwas_eqtl[which(colocResult$results$SNP.PP.H4 > 0.75)]$snpId, tissueSiteDetail=tissueSiteDetail) 
